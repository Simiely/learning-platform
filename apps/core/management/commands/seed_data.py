...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for slug, items, use_real_media in items_data:
            cat = cat_objs[slug]
            for idx, (name, en_name, emoji, img_file, audio_file, fact, img_pos, img_pos_ipad) in enumerate(items):
