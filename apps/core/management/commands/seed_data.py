...
ANIMALS = [
    ...
    # ====== 第4批（2026-07-29）梅花鹿 ======
    ('梅花鹿', 'deer_2026072913', 'Deer', '🦌', 'deer.jpg', 'deer.mp3',
     '梅花鹿在夏天身上有白色斑点像梅花，到了冬天斑点就消失了。只有雄鹿长角，每年都会脱落重新长。',
     '50% 50%', '50% 50%', '50% 50%', 'wild'),
