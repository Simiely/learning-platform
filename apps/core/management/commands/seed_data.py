...
ANIMALS = [
    ...
    # ====== 第7批（2026-07-31）精选补充 10 种 ======
    ('山羊', 'goat_2026073101', 'Goat', '🐐', 'goat.jpg', 'goat.mp3',
     '山羊是非常敏捷的山地动物，它们的瞳孔是长方形的，视野可达320度，几乎能看到身后。',
     '50% 50%', '50% 50%', '50% 40%', 'farm'),
    ('羊驼', 'alpaca_2026073102', 'Alpaca', '🦙', 'alpaca.jpg', 'alpaca.mp3',
     '羊驼是骆驼的亲戚，性格温顺可爱。它们生气时会向对方吐口水，口水有很强的气味！',
     '50% 50%', '50% 50%', '50% 18%', 'farm'),
    ('浣熊', 'raccoon_2026073103', 'Raccoon', '🦝', 'raccoon.jpg', 'raccoon.mp3',
     '浣熊是聪明的小动物，它们吃东西前喜欢在水里洗一洗。前爪非常灵活，能打开瓶盖和门锁。',
     '30% 50%', '20% 50%', '50% 50%', 'wild'),
    ('猎豹', 'cheetah_2026073104', 'Cheetah', '🐆', 'cheetah.jpg', 'cheetah.mp3',
     '猎豹是陆地上跑得最快的动物，3秒内可以加速到每小时100公里，比跑车还快！',
     '50% 50%', '30% 50%', '50% 50%', 'wild'),
    ('鸵鸟', 'ostrich_2026073105', 'Ostrich', '🌍', 'ostrich.jpg', 'ostrich.mp3',
     '鸵鸟是地球上最大的鸟类，虽然不会飞，但跑得比马还快。一只眼睛比它的脑袋还大。',
     '50% 50%', '50% 50%', '50% 40%', 'wild'),
    ('河狸', 'beaver_2026073106', 'Beaver', '🌍', 'beaver.jpg', 'beaver.mp3',
     '河狸是自然界的水坝工程师，会用树枝和泥巴建造水坝。它们的牙齿一生都在不停地长。',
     '50% 50%', '50% 50%', '50% 50%', 'wild'),
    ('龙虾', 'lobster_2026073107', 'Lobster', '🦞', 'lobster.jpg', 'lobster.mp3',
     '龙虾的血液是透明的，遇到空气才会变成蓝色。它们可以活到100岁以上，并且一生都在长大。',
     '50% 50%', '50% 50%', '50% 50%', 'ocean'),
    ('鱿鱼', 'squid_2026073108', 'Squid', '🦑', 'squid.jpg', 'squid.mp3',
     '鱿鱼有10条触手，遇到危险时会喷出墨汁然后快速逃走。大王酸浆鱿是地球上最大的无脊椎动物。',
     '40% 50%', '50% 50%', '50% 50%', 'ocean'),
    ('蝎子', 'scorpion_2026073109', 'Scorpion', '🦂', 'scorpion.jpg', 'scorpion.mp3',
     '蝎子在紫外线下会发出蓝色的光！它们的毒刺长在尾巴末端，有些蝎子的毒性比眼镜蛇还强。',
     '40% 50%', '40% 50%', '50% 50%', 'reptile'),
    ('蟋蟀', 'cricket_2026073110', 'Cricket', '🦗', 'cricket.jpg', 'cricket.mp3',
     '蟋蟀用翅膀摩擦来"唱歌"，雄蟋蟀的叫声越响亮越能吸引雌蟋蟀。通过叫声还能知道气温！',
     '40% 50%', '50% 50%', '50% 50%', 'reptile'),
]
